...
A portable device built with the Atmega328p.
...
`kicad-project/arduino-device.pro`.

```bash
git clone https://github.com/marcbperez/arduino-device
cd arduino-device
```
...
[issue-tracker]: https://github.com/marcbperez/arduino-device/issues
